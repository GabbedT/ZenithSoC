...
riscv32-unknown-elf-ld -T linker.ld -o output.elf setup.o test.o UART.o GPIO.o Timer.o /opt/riscv/lib/gcc/riscv32-unknown-elf/12.2.0/libgcc.a /opt/riscv/riscv64-unknown-elf/lib/rv32im/ilp32/libc.a
