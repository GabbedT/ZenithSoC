...
riscv32-unknown-elf-g++ -flto -O2 -march=rv32im_zicsr_zfinx_zba_zbb -nostartfiles -T linker.ld -o output.elf setup.o prng.o SerialOut.o PRNG.o Timer.o GPIO.o /opt/riscv/lib/gcc/riscv32-unknown-elf/14.2.0/libgcc.a /opt/riscv/riscv32-unknown-elf/lib/libc.a
