...
#
# Script generated by Vivado on Tue Aug 04 18:33:30 CEST 2026
# SW Build 6511674 on Tue Jun 16 11:01:26 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_clocking.sh
...
#
# Usage        : system_clocking.sh
#                system_clocking.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_clocking.sh [-rerun]
#                system_clocking.sh [-reset_run]
#                system_clocking.sh [-clean]
#                system_clocking.sh [-reset_log]
#                system_clocking.sh [-help]
#
...
#                script (type 'system_clocking.sh -help' for more information).
#
...
# script info
echo -e "system_clocking.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_clocking.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ip_user_files/ipstatic" +incdir+"../../../../../../../../../../../tools/Xilinx/2026.1/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ip_user_files/ipstatic" +incdir+"../../../../../../../../../../../tools/Xilinx/2026.1/data/rsb/busdef" \
  "srcs/sources_1/ip/system_clocking/system_clocking_clk_wiz.v" \
  "srcs/sources_1/ip/system_clocking/system_clocking.v" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_clocking xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_clocking -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_clocking_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_clocking.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_clocking.sh [-help]\n\
Usage: system_clocking.sh [-step]\n\
Usage: system_clocking.sh [-lib_map_path]\n\
Usage: system_clocking.sh [-rerun]\n\
Usage: system_clocking.sh [-reset_run]\n\
Usage: system_clocking.sh [-clean]\n\
Usage: system_clocking.sh [-reset_log]\n\
Usage: system_clocking.sh [-keep_index]\n\
Usage: system_clocking.sh [-noclean_files]\n\n\
