...
VL_ATTR_COLD void Vtb_top___024root___eval_triggers__stl(Vtb_top___024root* vlSelf) {
    ...
    vlSelfRef.__VstlTriggered.set(1U, ((IData)(vlSelfRef.tb_top__DOT__u_dut__DOT__u_uart__DOT__tx_idle) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb_top__DOT__u_dut__DOT__u_uart__DOT__tx_idle__0)));
